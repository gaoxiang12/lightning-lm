...
public:
    ...
    lio_sam::msg::CloudInfo latestFeatureInfo;
    std_msgs::msg::Header cloudHeader;
    bool hasFeatureInfo = false;
...
#else
        RCLCPP_WARN(get_logger(), "[LIGHTNING_OFFLINE] FeatureExtraction topic endpoints disabled.");
#endif
